...
export class RelationsService {
    ...
    async upsertRelations(): Promise<Relation> {
        ...
        const blockRelationSlugName = 'data_retention';
        const blockRelationGroupName = 'Data Retention';
        const blockRelationName = 'data-retention';
        const blockRelationDescription = 'Data Retention Settings';
        return await this.upsertSettingsRelation(blockRelationSlugName, blockRelationGroupName, blockRelationName, blockRelationDescription);
    }
}
